...
async def text(bot, update):
    ...
    reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ CHANNEL ⭕️", url="https://t.me/Dads_links")], [InlineKeyboardButton(text="😇 SUPPORT", url="https://t.me/Dads_links_bot"),
